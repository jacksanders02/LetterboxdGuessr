      ...
      <div className="flex-fill-remaining-space flex flex-col gap-8 lg:grid lg:grid-rows-1 lg:grid-cols-5 text-sm">
        <div className="flex flex-row lg:flex-col gap-2">
          ...
          <div className="flex flex-col gap-4 text-xs xl:text-base">
            <p><span className={'underline'}>Released:</span> 2024</p>
            <p><span className={"underline"}>IMDB Rating:</span> 3.8</p>
            <p><span className={"underline"}>Genre:</span> Action, Adventure, Sci-Fi</p>
            <p><span className={"underline"}>Starring:</span> Sydney Sweeney, Dakota Johnson, and Isabela Merced</p>
            <p><span className={"underline"}>Directed By:</span> SJ Clarkson</p>
          </div>
        </div>
        <div className='flex flex-col items-center gap-8 lg:gap-16 text-center lg:col-span-3 md:text-base xl:text-xl'>
          <div className={'flex flex-col items-center gap-2 lg:gap-4'}>
            <p>
              “We come to this place… for magic.<br />
              We come to the theater to laugh, to cry, to care.<br />
              Because we need that, all of us:<br />
              that indescribable feeling we get when the lights begin to dim,<br />
              and we go somewhere we've never been before;<br />
              not just entertained, but somehow reborn.... together.<br />
              Dazzling images, on a huge silver screen.<br />
              Sound that I can feel.<br />
              Somehow, heartbreak feels good in a place like this.<br />
              Our heroes feel like the best part of us,<br />
              and stories feel perfect and powerful.<br />
              Because here...<br />
              They are.”
            </p>
          ...
          <div className={fontSans.className}>
            <input type={"text"} placeholder={"Make a guess..."} className={'text-lg xl:text-3xl px-2 py-2 border-text border-2 rounded-sm'}></input>
            <p>Guess Button</p>
